...
This directory is about RadiantIQ's `course service`. It provides the starting point and workflow for building microservices-based application.
...
docker compose up -d
```
Go to http://localhost:3004/ to check the status! (The port specified in docker-compose.yml)
